package com.rakeyjake.server.model.items;
...
public class Item {
	...
	public static boolean playerBoots(int itemId) {
		String[] data = {
			"Shoes", "shoes", "boots", "Boots", "Flippers"
		};
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	public static boolean playerGloves(int itemId) {
		String[] data = {
			"Gloves", "gloves", "glove", "Glove", "gauntlets", "Gauntlets", "Vamb", "Vambraces", "vamb", "vambraces"
		};
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	public static boolean playerAmulet(int itemId) {
		String[] data = {
			"amulet", "Amulet", "Pendant", "pendant", "Symbol", "symbol", "scarf", "Scarf"
		};
		String item = getItemName(itemId);
		if (item == null) {
			return false;
