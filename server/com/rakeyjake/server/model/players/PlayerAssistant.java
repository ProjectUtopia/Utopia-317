...
public class PlayerAssistant {
	...
	public void applyDead() {
		...
		if (c.duelStatus != 6) {
			...
			if (o != null) {
				...
				if (o.inWild() && !(c.npcIndex > 0)) {
					o.pkPoints++;
					o.kills++;
					o.sendMessage("You have received a pk point, you now have "
							+ o.pkPoints + " pk points.");
					c.sendMessage("You were defeated by " + o.playerName + "!");
					c.deaths++;
				}
				if (o.duelStatus == 5) {
					o.duelStatus++;
	...
	public void levelUp(int skill) {
		...
		case 19:
			...
			sendFrame126("Your farming level is now "
					+ getLevelForXP(c.playerXP[skill]) + ".", 4890);
			sendFrame126("", 4891);
	...
	public void handleLoginText() {
		...
		c.getPA().sendFrame126(" Command Centre", 663);
		c.getPA().sendFrame126("1. Server Info", 7333);
		// The command centre is where you can control the main functions of
		// your
		// character and get information and help.
		c.getPA().sendFrame126("2. Command List", 7334);
		c.getPA().sendFrame126("3. Staff List", 7336);
		c.getPA().sendFrame126("4. Contact Staff Member", 7383);
		c.getPA().sendFrame126("---", 7339);
		c.getPA().sendFrame126("5. Why donate?", 7338);
		c.getPA().sendFrame126("6. Donator commands", 7340);
		c.getPA().sendFrame126("---", 7341);
		c.getPA().sendFrame126("7. Why vote?", 7342);
		c.getPA().sendFrame126("9. Click to vote", 7337);
		c.getPA().sendFrame126("10. Skilling Guide", 7335);
		c.getPA().sendFrame126("---", 7343);// should be 9
		c.getPA().sendFrame126("11. Combat Guide", 7344);
		c.getPA().sendFrame126("12. PKing Guide", 7345);
		c.getPA().sendFrame126("7. Click to donate", 7346);
		c.getPA().sendFrame126("13. Boss Guide", 7347);
		c.getPA().sendFrame126("14. Minigame Guide", 7348);
		c.getPA().sendFrame126("", 682); // MEMBERS QUESTS BIT
		c.getPA().sendFrame126("", 12772);
		c.getPA().sendFrame126("", 673);
		c.getPA().sendFrame126("", 7352);
		c.getPA().sendFrame126("3453452352354", 17510); // +crush
