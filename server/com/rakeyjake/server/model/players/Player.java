...
import com.rakeyjake.server.model.items.Item;
import com.rakeyjake.server.model.npcs.NPC;
import com.rakeyjake.server.model.npcs.NPCHandler;
import com.rakeyjake.server.util.ISAACRandomGen;
...
public abstract class Player {
	...
	public boolean initialized = false, disconnected = false,
			...
			addStarter = false, accountFlagged = false, jailed,
			msbSpec = false;
	   //dragon claws
	...
	saveDelay, playerKilled, totalPlayerDamageDealt, killedBy, lastChatId = 1,
			privateChat, friendSlot = 0, dialogueId, randomCoffin, newLocation,
			specEffect, specBarId, attackLevelReq, defenceLevelReq,
			strengthLevelReq, rangeLevelReq, magicLevelReq, followId,
			skullTimer, votingPoints, nextChat = 0, talkingNpc = -1,
			...
			killCount = 0;
	public int pkPoints, kills, deaths; // custom added
	...
	protected void appendPlayerAppearance(Stream str) {
		synchronized (this) {
			...
			int combatLevel = ((Client) this).calculateCombatLevel();
