...
import com.rakeyjake.server.model.items.GameItem;
	...
	public void processPacket(final Client c, int packetType, int packetSize) {
		...
		case 9190:
			if (c.teleAction == 1) {
				...
				c.sendMessage("I hope you didn't forget your spade. Luckily there's one on the floor anyway.");
				...
				c.getPA().spellTeleport(3046, 9779, 0); // mining/smithing
		...
		case 9191:
			if (c.teleAction == 1) {
				...
				c.getPA().spellTeleport(3043, 4975, 1); // Rogues den, cooking
			}
			if (c.dialogueAction == 10) {
		...
		case 9193:
			if (c.teleAction == 1) {
				...
				// woodcutting location
				c.getPA().spellTeleport(2330, 3680, 0);
				c.sendMessage("Happy chopping!");
			}
			if (c.dialogueAction == 10) {
		...
		case 50245:
		case 117123:
			c.getDH().sendOption5("Barrows", "Pest Control", "Tzhaar",
					"Duel Arena", "Coming Soon");
			c.teleAction = 2;
			break;
		...
		case 4146:
		case 117131:
			c.getDH().sendOption5("Godwars", "King Black Dragon (Wildy)",
					"Dagannoth Kings", "Chaos Elemental(Wildy)", "Coming Soon");
			c.teleAction = 3;
			break;
		...
		case 4150:
		case 117154:
			c.getDH().sendOption5("Varrock Wild", "Graveyard", "44 Portals",
					"Greater Demons", "Ardy Lever");
			c.teleAction = 4;
			break;
		...
		case 47130:
			if (c.slayerTask != 0) {
				...
				c.sendMessage("You currently do not have a slayer task.");
			}
			break;
