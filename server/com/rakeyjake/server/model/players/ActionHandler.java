...
import com.rakeyjake.server.util.ScriptManager;
...
public class ActionHandler {
	...
	public void firstClickObject(int objectType, int obX, int obY) {
		...
		case 10284:
			if (c.barrowsKillCount < 5) {
				...
				c.sendMessage("You have been teleported back to kill the remaining brothers.");
			}
			if (c.barrowsKillCount == 5
			...
			if ((c.barrowsKillCount > 5 || c.barrowsNpcs[c.randomCoffin][1] == 2)
				...
				c.sendMessage("You need at least 2 free spaces in your inventory.");
			}
			break;
		/*
		 * Doors
		...
		case 6823:
			if (com.rakeyjake.server.model.minigames.Barrows.selectCoffin(c, objectType)) {
				return;
			}
		...
		case 8143:
			...
			//Fishing spots that are objects
		case 14939:
	...
	public void secondClickObject(int objectType, int obX, int obY) {
		...
		case 2090:
		case 2091:
			c.sendMessage("This rock contains Copper Ore.");
			break;
		case 2094:
			c.sendMessage("This rock contains Tin Ore.");
			break;

		case 145856:
		case 2092:
		case 2093: // iron
			c.sendMessage("This rock contains Iron Ore.");
			break;

		case 2098:
		case 2099:
			c.sendMessage("This rock contains Gold Ore.");
			break;
		...
		case 2096:
		case 2097: // coal
			c.sendMessage("This rock contains Coal.");
			break;
		...
		case 14854:
		case 14855: // mith ore
			c.sendMessage("This rock contains Mithril Ore.");
			break;

		case 2105:
		case 14862: // addy ore
			c.sendMessage("This rock contains Adamant Ore.");
			break;

		case 14859:
		case 14860: // rune ore
			c.sendMessage("This rock contains Runite Ore.");
			break;
	...
	public void firstClickNpc(int i) {
		...
		case 315: // trout + salmon
			c.getFishing().setupFishing(335);
			break;

		case 334: //Manta Rays
		//	c.getFishing().setupFishing(389);
			c.getDH().sendStatement("Please harpoon this spot for sharks.");
			break;
		...
		case 324: //tuna
			c.getDH().sendStatement("Please harpoon this spot for tuna (35+) and swordfish (50+).");
			break;
	...
	public void secondClickNpc(int i) { // this is the second option on the npc.
		c.clickNpcType = 0;
		c.npcClickIndex = 0;
		switch (i) {
		case 1282:
		...
		case 2271:
			...
			//START OF SECOND CLICK FISHING
		case 312: //lobs
			c.getDH().sendStatement("Please cage this spot for lobsters.");
			break;
		...
		case 319: //Shrimp
			c.getDH().sendStatement("Please net this spot for shrimp");
			break;
			
		case 315: // trout + salmon
			c.getDH().sendStatement("Please lure this spot for trout and salmon.");
			break;
			
		case 324://tuna
			c.getFishing().setupFishing(359);
			break;
			// END OF SECOND CLICK FISHING
	...
	public void thirdClickNpc(int npcType) { // this is the third option on the
												// npc
		c.clickNpcType = 0;
		c.npcClickIndex = 0;
		switch (npcType) {
