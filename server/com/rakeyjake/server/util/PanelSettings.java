...
public class PanelSettings {
	...
	public PanelSettings(ControlPanel controlPanel) {
		this.p = controlPanel;
	}
	...
	public void executeCommand(String cmd) {
		...
		if (cmd.equalsIgnoreCase("Teleport All")) {
			...
			p.displayMessage("You successfully teleport all players to "
					+ (area.equals("Custom Location") ? "x" + x + " y" + y
							+ " z" + z : area) + "!", cmd, 1);
			return;
		}
		...
		if (cmd.equalsIgnoreCase("Update")) {
			Server.playerHandler.updateSeconds = (Integer
	...
	public void playerCommand(String cmd, Client c) {
		...
		if (cmd.equals("Force Shop")) {
			...
			String name = (String) JOptionPane.showInputDialog(null,
					"Chose the Equipment you wish to remove:\n",
					"Magic Bomber", -1, null, Server.shopHandler.ShopName,
					Server.shopHandler.ShopName);
		...
		if (cmd.equals("Reset All Skills")) {
			...
			c.sendMessage("Your skills have been reset by Jake");
		}
