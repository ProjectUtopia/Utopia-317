...
import com.rakeyjakey.client.animation.Animable_Sub3;
...
public class Client extends RSApplet {
				...
				if (chatMessages[k] != null) {
					...
					if (chatType == 16) {
						...
						if (chatTypeView == 11 || chatTypeView == 0) {
							...
							textDrawingArea.method385(255, "" + clanname + "",
									yPos, 14);
							textDrawingArea.method385(0, "]", yPos,
									clanNameWidth + 14);

							textDrawingArea.method385(0, chatNames[k] + ":",
									yPos, j2 - 17); // j2
							j2 += textDrawingArea.getTextWidth(chatNames[k]) + 7;
							textDrawingArea.method385(0x800000,
									chatMessages[k], yPos, j2 - 16);// j2
							j++;
							j77++;
						}
					}
	...
	private void resetImageProducers2() {
		...
		aRSImageProducer_1166 = new RSImageProducer(519, 165,
				getGameComponent());
		aRSImageProducer_1164 = new RSImageProducer(246, 164,
				getGameComponent());
		DrawingArea.setAllPixelsToZero();
	...
	void startUp() {
		...
		try {
			...
			while (onDemandFetcher.getNodeCount() > 0) {
				...
				if (j1 > 0)
					drawLoadingText(65, "Loading animations - " + (j1 * 100)
							/ k + "%");
				processOnDemandQueue();
				try {
					Thread.sleep(100L);
			...
			if (decompressors[0] != null) {
				...
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(0, 48, 47));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(1, 48, 47));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(0, 48, 48));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(1, 48, 48));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(0, 48, 49));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(1, 48, 49));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(0, 47, 47));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(1, 47, 47));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(0, 47, 48));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(1, 47, 48));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(0, 148, 48));
				onDemandFetcher.method558(3,
						onDemandFetcher.method562(1, 148, 48));
				k = onDemandFetcher.getNodeCount();
				while (onDemandFetcher.getNodeCount() > 0) {
			...
			if (class9_1.type == 0) {
				...
				if (class9_1.type == 2) {
					...
					int lunarSpellsToBeLit[] = { 30075, 30083, 30106,
							30114/* , 30306 */, 30064 };
					for (int i = 0; i < lunarSpellsToBeLit.length; i++) {
						if (class9_1.id == lunarSpellsToBeLit[i])
							sprite = class9_1.sprite2;
					}

					// if (class9_1.id == 30306 || class9_1.id == 30064)
					// sprite = class9_1.sprite2;
