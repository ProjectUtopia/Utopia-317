...
public final class RSInterface {
	...
	public static void unpack(StreamLoader streamLoader,
		...
		interfaceCache = new RSInterface[40000];
		while (stream.currentOffset < stream.buffer.length) {
			...
			if (rsInterface.type == 4) {
		           rsInterface.message = stream.readString().replaceAll("RuneScape", "Utopia");
	...
	public static void equipmentScreen(TextDrawingArea[] wid) {
		...
		addButton(19144, 6, "Equipment/CUSTOM", 150, 40,
				"Show Equipment Stats", 1);
	...
	public static void configureLunar(TextDrawingArea[] TDA) {
		...
		addLunar3RunesSmallBox(30064, 9075, 563, 557, 1, 0, 1, 30012, 30006,
				68, "Monster Teleport", "A teleportation spell", TDA, 6, 0, 5);
		addLunar3RunesBigBox(30075, 9075, 563, 557, 1, 0, 3, 30012, 30006, 69,
				"Minigame Teleport", "A teleportation spell", TDA, 7, 0, 5);
		addLunar3RunesSmallBox(30083, 9075, 563, 557, 1, 0, 5, 30012, 30006,
				70, "Boss Teleport", "A teleportation spell", TDA, 8, 0, 5);
		...
		addLunar3RunesSmallBox(30106, 9075, 563, 555, 1, 0, 0, 30012, 30004,
				71, "Pking Teleport", "A teleportation spell", TDA, 11, 0, 5);
		addLunar3RunesBigBox(30114, 9075, 563, 555, 1, 0, 4, 30012, 30004, 72,
				"Skill Teleport", "A teleportation spell", TDA, 12, 0, 5);
		...
		addLunar3RunesBigBox(30138, 9075, 563, 554, 1, 1, 2, 30012, 30003, 74,
				"City Teleport", "A teleportation spell", TDA, 15, 0, 5);
		addLunar3RunesBigBox(30146, 9075, 563, 554, 1, 1, 5, 30012, 30003, 75,
				"City Teleport(2)", "A teleportation spell", TDA, 16, 0, 5);
		...
		addLunar3RunesSmallBox(30162, 9075, 563, 555, 1, 1, 3, 30012, 30004,
				77, "Godwars Teleport", "A teleportation spell", TDA, 18, 0, 5);
		addLunar3RunesSmallBox(30170, 9075, 563, 555, 1, 1, 7, 30012, 30004,
				78, "Tele Group Khazard", "A teleportation spell", TDA, 19, 0,
				5);
		...
		addLunar3RunesSmallBox(30226, 9075, 563, 555, 2, 2, 9, 30012, 30004,
				84, "Fishing Guild Teleport", "A teleportation spell", TDA, 26,
				0, 5);
		addLunar3RunesLargeBox(30234, 9075, 563, 555, 1, 2, 13, 30012, 30004,
				85, "Tele Group Fishing Guild", "A teleportation spell", TDA,
				27, 0, 5);
		...
		addLunar3RunesSmallBox(30250, 9075, 563, 555, 2, 2, 9, 30012, 30004,
				86, "Catherby Teleport", "A teleportation spell", TDA, 29, 0, 5);
		addLunar3RunesSmallBox(30258, 9075, 563, 555, 2, 2, 14, 30012, 30004,
				87, "Tele Group Catherby", "A teleportation spell", TDA, 30, 0,
				5);
		addLunar3RunesSmallBox(30266, 9075, 563, 555, 2, 2, 7, 30012, 30004,
				88, "Ice Plateau Teleport", "A teleportation spell", TDA, 31,
				0, 5);
		addLunar3RunesLargeBox(30274, 9075, 563, 555, 2, 2, 15, 30012, 30004,
				89, "Tele Group Ice Plateau", "A teleportation spell", TDA, 32,
				0, 5);
	...
	/*
	 * public static void configureLunar(TextDrawingArea[] TDA){ homeTeleport();
	 * drawRune(30003,1, "Fire"); drawRune(30004,2, "Water"); drawRune(30005,3,
	 * "Air"); drawRune(30006,4, "Earth"); drawRune(30007,5, "Mind");
	 * drawRune(30008,6, "Body"); drawRune(30009,7, "Death"); drawRune(30010,8,
	 * "Nature"); drawRune(30011,9, "Chaos"); drawRune(30012,10, "Law");
	 * drawRune(30013,11, "Cosmic"); drawRune(30014,12, "Blood");
	 * drawRune(30015,13, "Soul"); drawRune(30016,14, "Astral");
	 * addLunar3RunesSmallBox(30017, 553, 554, 555, 0, 4, 3, 30003, 30004, 64,
	 * "Bake Pie","Bake pies without a stove",TDA,0, 16,2);
	 * addLunar2RunesSmallBox(30025, 553, 557, 0, 7, 30006, 65,"Cure Plant",
	 * "Cure disease on farming patch",TDA,1, 4,2); addLunar3RunesBigBox(30032,
	 * 553, 564, 558, 0,0, 0, 30013, 30007, 65,"Monster Examine",
	 * "Detect the combat statistics of a\\nmonster",TDA, 2,2,2);
	 * addLunar3RunesSmallBox(30040, 553, 564, 556, 0, 0, 1, 30013, 30005, 66,
	 * "NPC Contact","Speak with varied NPCs",TDA,3,0,2);
	 * addLunar3RunesSmallBox(30048, 553, 563, 557, 0, 0, 9, 30012, 30006, 67,
	 * "Cure Other","Cure poisoned players",TDA,4,8,2);
	 * addLunar3RunesSmallBox(30056, 553, 555, 554, 0, 2, 0, 30004, 30003, 67,
	 * "Humidify","fills certain vessels with water",TDA,5,0,5);
	 * addLunar3RunesSmallBox(30064, 553, 563, 557, 1, 0, 1, 30012, 30006, 68,
	 * "Monster Teleport","Teleports you to various monsters",TDA,6,0,5);
	 * addLunar3RunesBigBox(30075, 553, 563, 557, 1, 0, 3, 30012, 30006,
	 * 69,"Minigame Teleport", "Teleport to various minigames",TDA, 7,0,5);
	 * addLunar3RunesSmallBox(30083, 553, 563, 557, 1, 0, 5, 30012, 30006, 70,
	 * "Boss teleport","Teleports you to various bosses",TDA,8,0,5);
	 * addLunar3RunesSmallBox(30091, 553, 564, 563, 1, 1, 0, 30013, 30012, 70,
	 * "Cure Me","Cures Poison",TDA,9,0,5); addLunar2RunesSmallBox(30099, 553,
	 * 557, 1, 1, 30006, 70,"Hunter Kit",
	 * "Get a kit of hunting gear",TDA,10,0,5); addLunar3RunesSmallBox(30106,
	 * 553, 563, 555, 1, 0,0, 30012, 30004, 71,"PKing teleport",
	 * "Teleport to various PKing locations",TDA,11,0,5);
	 * addLunar3RunesBigBox(30114, 553, 563, 555, 1, 0, 4, 30012, 30004,
	 * 72,"Skilling teleport", "Teleport to various skilling locations",TDA,
	 * 12,0,5); addLunar3RunesSmallBox(30122, 553, 564, 563, 1, 1, 1, 30013,
	 * 30012, 73, "Cure Group","Cures Poison on players",TDA,13,0,5);
	 * addLunar3RunesBigBox(30130, 553, 564, 559, 1, 1, 4, 30013, 30008,
	 * 74,"Stat Spy", "Cast on another player to see their\\nskill levels",TDA,
	 * 14,8,2); addLunar3RunesBigBox(30138, 553, 563, 554, 1, 1, 2, 30012,
	 * 30003, 74,"Wilderness Teleport", "Teleport to various Wildy spots.",TDA,
	 * 15,0,5); addLunar3RunesBigBox(30146, 553, 563, 554, 1, 1, 5, 30012,
	 * 30003, 75,"Tele Group Barbarian",
	 * "Teleports players to the Barbarian\\noutpost",TDA, 16,0,5);
	 * addLunar3RunesSmallBox(30154, 553, 554, 556, 1, 5, 9, 30003, 30005, 76,
	 * "Superglass Make","Make glass without a furnace",TDA,17, 16,2);
	 * addLunar3RunesSmallBox(30162, 553, 563, 555, 1, 1, 3, 30012, 30004, 77,
	 * "Khazard Teleport","Teleports you to Port khazard",TDA,18,0,5);
	 * addLunar3RunesSmallBox(30170, 553, 563, 555, 1, 1, 7, 30012, 30004, 78,
	 * "Tele Group Khazard","Teleports players to Port khazard",TDA,19,0,5);
	 * addLunar3RunesBigBox(30178, 553, 564, 559, 1, 0, 4, 30013, 30008,
	 * 78,"Dream", "Take a rest and restore hitpoints 3\\n times faster",TDA,
	 * 20,0,5); addLunar3RunesSmallBox(30186, 553, 557, 555, 1, 9, 4, 30006,
	 * 30004, 79, "String Jewellery","String amulets without wool",TDA,21,0,5);
	 * addLunar3RunesLargeBox(30194, 553, 557, 555, 1, 9, 9, 30006, 30004,
	 * 80,"Stat Restore Pot\\nShare",
	 * "Share a potion with up to 4 nearby\\nplayers",TDA, 22,0,5);
	 * addLunar3RunesSmallBox(30202, 553, 554, 555, 1, 6, 6, 30003, 30004, 81,
	 * "Magic Imbue","Combine runes without a talisman",TDA,23,0,5);
	 * addLunar3RunesBigBox(30210, 553, 561, 557, 2, 1, 14, 30010, 30006,
	 * 82,"Fertile Soil", "Fertilise a farming patch with super\\ncompost",TDA,
	 * 24, 4,2); addLunar3RunesBigBox(30218, 553, 557, 555, 2, 11, 9, 30006,
	 * 30004, 83,"Boost Potion Share",
	 * "Shares a potion with up to 4 nearby\\nplayers",TDA, 25, 0,5);
	 * addLunar3RunesSmallBox(30226, 553, 563, 555, 2, 2, 9, 30012, 30004, 84,
	 * "Fishing Guild Teleport"
	 * ,"Teleports you to the fishing guild",TDA,26,0,5);
	 * addLunar3RunesLargeBox(30234, 553, 563, 555, 1, 2, 13, 30012, 30004, 85,
	 * "Tele Group Fishing\\nGuild",
	 * "Teleports players to the Fishing\\nGuild",TDA, 27,0,5);
	 * addLunar3RunesSmallBox(30242, 553, 557, 561, 2, 14, 0, 30006, 30010, 85,
	 * "Plank Make","Turn Logs into planks",TDA,28,16,5);
	 * addLunar3RunesSmallBox(30250, 553, 563, 555, 2, 2, 9, 30012, 30004, 86,
	 * "Catherby Teleport","Teleports you to Catherby",TDA,29,0,5);//END //BELOW
	 * HERE DON'T SHOW ON HOVER addLunar3RunesSmallBox(30258, 553, 563, 555, 2,
	 * 2, 14, 30012, 30004, 87,
	 * "Tele Group Catherby","Teleports players to Catherby",TDA,30,0,5);
	 * addLunar3RunesSmallBox(30266, 553, 563, 555, 2, 2, 7, 30012, 30004, 88,
	 * "Ice Plateau Teleport","Teleports you to Ice Plateau",TDA,31,0,5);
	 * addLunar3RunesBigBox(30274, 553, 563, 555, 2, 2, 15, 30012, 30004, 89,
	 * "Tele Group Ice\\n Plateau"
	 * ,"Teleports players to Ice Plateau",TDA,32,0,5);
	 * addLunar3RunesBigBox(30282, 553, 563, 561, 2, 1, 0, 30012, 30010, 90,
	 * "Energy Transfer",
	 * "Spend hitpoints and SA Energy to\\n give another player hitpoints and run energy"
	 * ,TDA,33,8,2); addLunar3RunesBigBox(30290, 553, 563, 565, 2, 2, 0, 30012,
	 * 30014, 91,
	 * "Heal Other","Transfer up to 75% of hitpoints\\n to another player"
	 * ,TDA,34,8,2); addLunar3RunesBigBox(30298, 553, 560, 557, 2, 1, 9, 30009,
	 * 30006, 92,
	 * "Vengeance Other","Allows another player to rebound\\ndamage to an opponent"
	 * ,TDA,35,8,2); addLunar3RunesSmallBox(30306, 553, 560, 557, 3, 1, 9,30009,
	 * 30006, 93, "Vengeance","Rebound damage to an opponent",TDA,36,0,5);
	 * addLunar3RunesBigBox(30314, 553, 565, 563, 3, 2, 5, 30014, 30012, 94,
	 * "Heal Group","Transfer up to 75% of hitpoints to a group",TDA,37,0,5);
	 * addLunar3RunesBigBox(30322, 553, 564, 563, 2, 1, 0, 30013, 30012, 95,
	 * "Spellbook Swap"
	 * ,"Change to another spellbook for 1\\nspell cast",TDA,38,0,5); }
	 */
	...
	public static void constructLunar() {
		...
		// setBounds(30307, 5, 176, 71, Interface); //TEST
	}
