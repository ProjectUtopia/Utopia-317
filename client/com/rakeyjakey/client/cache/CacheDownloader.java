...
public class CacheDownloader {
	 ...
	 * It just pauses the entire code for the amount of time set.
	 */
	private final int pauseHandlerDelay = 1000;

	/**
	 * URL of cache on remote server.
	 */
	private String cacheLink = "http://rakeyjakey.com/rsps/cache.zip";

	/**
	 * The local location of the cache.
	 */
	...
	public void cacheHasUpdated() {
		JOptionPane
				.showMessageDialog(
						frame,
						"The cache has updated. Please click OK to proceed with the update.",
